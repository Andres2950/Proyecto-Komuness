...
router.get('/check', auth_middleware_1.authMiddleware, usuario_controller_1.checkAuth); // verificar el token
...
router.put('/:id/limite', auth_middleware_1.authMiddleware, (0, roles_middleware_1.verificarRoles)([0, 1]), usuario_controller_1.actualizarLimiteUsuario); // Actualizar límite personalizado
router.put('/:id/premium-vencimiento', auth_middleware_1.authMiddleware, (0, roles_middleware_1.verificarRoles)([0, 1]), usuario_controller_1.actualizarVencimientoPremium); // Actualizar vencimiento premium
...
router.put('/:id', auth_middleware_1.authMiddleware, (0, roles_middleware_1.verificarRoles)([0, 1, 2, 3]), usuario_controller_1.updateUsuario); //update
// para cualquier usuario registrado
router.put('/me/premium', auth_middleware_1.authMiddleware, (0, roles_middleware_1.verificarRoles)([0, 1, 2, 3]), // superadmin, admin, usuario normal
usuario_controller_1.activarPremiumActual);
